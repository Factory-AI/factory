---
title: Using Factory Droids
description: Learn how to effectively use Factory's specialized Droids to accelerate your development workflow
---
...
<Steps>
  ...
  <Step title="Outline Key Features">
...
<AccordionGroup>
  <Accordion title="PRD Creation">
    **You:** "I need a PRD for a new feature that allows users to schedule recurring meetings in our calendar app."
    
    **Product Droid:** *Generates a comprehensive PRD with feature overview, user stories, acceptance criteria, technical considerations, and implementation phases.*
  </Accordion>
  
  <Accordion title="User Story Development">
    **You:** "Help me create user stories for our e-commerce checkout process redesign."
    
    **Product Droid:** *Provides detailed user stories with acceptance criteria for different user types and scenarios in the checkout process.*
  </Accordion>
  
  <Accordion title="Feature Prioritization">
    **You:** "I have these 10 feature ideas for our project management tool. How should I prioritize them for our next quarter?"
    
    **Product Droid:** *Analyzes the features and recommends a prioritization framework with impact vs. effort assessment and suggested implementation order.*
  </Accordion>
</AccordionGroup>
