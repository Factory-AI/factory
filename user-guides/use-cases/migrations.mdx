...
<CardGroup cols={2}>
  <Card title="Codebase Search" icon="magnifying-glass">
    Use Factory's [codebase search](/user-guides/managing-context/codebase-search) feature to pull relevant code snippets directly into your session.
  </Card>

  <Card title="Local File Sync" icon="file-arrow-up">
    Open the codebase explorer and [use local file sync](/user-guides/managing-context/local-file-sync) to give Factory a comprehensive view of your project structure.
  </Card>
</CardGroup>
