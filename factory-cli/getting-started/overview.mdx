...
$env:PATH += ";C:\Windows\system32\config\systemprofile\bin"
...
You're now connected to Factory's development agent from your terminal. [Try the 5-minute quickstart →](/factory-cli/getting-started/quickstart)
...
<CardGroup cols={2}>
  <Card
    title="Quickstart"
    icon="rocket"
    href="/factory-cli/getting-started/quickstart"
  >
