...
For complex features, use [Specification Mode](/factory-cli/user-guides/specification-mode) which automatically provides planning and review before implementation:
...
**Use AGENTS.md files** to document build commands, testing procedures, and coding standards. Droid reads these automatically, so you don't have to repeat project conventions. See the [AGENTS.md guide](/factory-cli/configuration/agents-md) for detailed setup instructions.
...
Ready to try these patterns? Head back to the [Quickstart](/factory-cli/getting-started/quickstart) and practice with your own code.
