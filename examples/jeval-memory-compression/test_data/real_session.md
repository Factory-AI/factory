## Session Intent
Implement JWT authentication for the Express API and fix a 401 error on the /api/login endpoint.
...
- decided to set token expiry to 24h because users complained about being logged out too frequently
...
## Current State
- authentication flow working end to end in development
