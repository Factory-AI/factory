...
import { GithubRepo } from '/snippets/vars.mdx';
...
With <GithubRepo repo="action">Droid Action</GithubRepo>, comment on a pull request to trigger an on-demand security review:
