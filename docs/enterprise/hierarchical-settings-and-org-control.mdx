...
Below is the full schema for org-managed settings. These are configured by org admins through the <a href={vars.urls.app}>Enterprise Controls</a> page in the <ProductName variant="factoryApp" />. Every property is optional — omit any field you do not need to set.
...
These controls are managed by org administrators in the **Enterprise Controls** section of the <a href={vars.urls.app}>Factory App</a>.
