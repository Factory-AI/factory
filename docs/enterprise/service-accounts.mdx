...
Service accounts are non-human identities for running Factory automation. Use them when a workload should belong to your organization instead of a specific teammate, such as CI/CD pipelines, scripts, Slack automations, or Droid Computers.
...
<CardGroup cols={2}>
  ...
  <Card title="Configure Git access" icon="git-branch">
...
<CardGroup cols={2}>
  ...
  <Card title="Persistent computers" icon="monitor">
