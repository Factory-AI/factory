...
<CardGroup cols={2}>
  <Card title="Create a service account" icon="user-plus">
    Add a stable identity from the API keys section in Settings. Give it a clear name and optional description so teammates know what it runs. Only managers and owners can create a service account, and service accounts are editable org-wide by all managers and owners.
  </Card>
