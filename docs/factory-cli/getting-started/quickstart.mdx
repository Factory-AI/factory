...
```powershell Windows
irm https://app.factory.ai/cli/windows | iex; $env:PATH += ";C:\Windows\system32\config\systemprofile\bin"
```
...
For larger features, use [Specification Mode](/factory-cli/user-guides/specification-mode) which automatically provides planning before implementation without needing to explicitly request it.
...
<CardGroup cols={2}>
  <Card
    ...
    icon="lightbulb"
    href="/factory-cli/getting-started/common-use-cases"
  >
  ...
  <Card
    title="Configuration"
    icon="gear"
    href="/factory-cli/configuration/settings"
  >
  ...
  <Card
    ...
    icon="file-text"
    href="/factory-cli/configuration/agents-md"
  >
  ...
  <Card
    ...
    icon="code"
    href="/factory-cli/configuration/ide-integrations"
  >
