...
description: "Manage MCP servers and configurations in factory-cli"
---
...
<Tip>
    MCP servers extend Factory's capabilities by providing additional tools and context. Make sure
