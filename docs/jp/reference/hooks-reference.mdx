...
<Warning>
  **Always use absolute paths** for hook commands and scripts, not relative paths. 
  ...
  Use __PRESERVE_40__ for project-relative scripts or full paths like 
  __PRESERVE_41__ or __PRESERVE_42__ for global scripts.
</Warning>
...
<Note>
  Plugin hooks use the same format as regular hooks with an optional __PRESERVE_51__ field to explain the hook's purpose.
</Note>
...
<Warning>
  ...
  the __PRESERVE_93__ hook where stdout is injected as context.
</Warning>
...
<Note>
  The __PRESERVE_129__ and __PRESERVE_130__ fields are deprecated for PreToolUse hooks.
  Use __PRESERVE_131__ and
  __PRESERVE_132__ instead. The deprecated fields
  __PRESERVE_133__ and __PRESERVE_134__ map to __PRESERVE_135__ and __PRESERVE_136__ respectively.
</Note>
...
<Note>
  For __PRESERVE_165__ hooks, you can inject context using either method:

  * Exit code 0 with stdout: Droid sees the context (special case for __PRESERVE_166__)
