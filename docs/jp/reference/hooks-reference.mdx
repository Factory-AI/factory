---
title: "フックリファレンス"
description: "Droidでフックを実装するためのリファレンスドキュメント"
---

<Tip>
  例付きのクイックスタートガイドは、[フックを始める](/cli/configuration/hooks-guide)を参照してください。
</Tip>
...
<Tip>
  コード整形、通知、ファイル保護などの実践的な例は、入門ガイドの[その他の例](/cli/configuration/hooks-guide#more-examples)を参照してください。
</Tip>
