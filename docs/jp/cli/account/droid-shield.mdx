...
<Tip>
  **高度な保護をお探しですか？** [Droid Shield Plus](/cli/account/droid-shield-plus)は、プロンプトインジェクション検出、強化されたシークレット検出、機密データ保護を備えたAI搭載セキュリティスキャンを提供します。エンタープライズのお客様が利用できます。
</Tip>
...
<CardGroup cols={2}>
  <Card title="セキュリティ概要" icon="shield" href="/cli/account/security">
    Factoryの包括的なセキュリティ機能とベストプラクティスについて学びます。
  </Card>
  <Card title="設定" icon="gear" href="/cli/configuration/settings">
