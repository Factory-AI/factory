...
description: エンタープライズ組織向けの、プロンプトインジェクション、シークレット検出、機密データ保護のためのAI搭載セキュリティスキャン。
...
Droid Shield Plusは、プロンプトインジェクション攻撃、機密データの露出、その他のセキュリティ脅威に対するリアルタイム保護を提供する高度なAI搭載セキュリティレイヤーです。パターンベースの検出を使用する標準的な[Droid Shield](/cli/account/droid-shield)とは異なり、Droid Shield Plusはエンタープライズ組織向けに、インテリジェントでコンテキストを認識するセキュリティスキャンを提供します。
...
<Steps>
  ...
  <Step title="Verify Activation">
    プロンプトインジェクション、機密データ、有害コンテンツに対するAI搭載セキュリティスキャンが有効であることを確認できます。
  </Step>
</Steps>
...
Droid Shield Plusは、組織によって管理されるエンタープライズアドオンです：

- **リアルタイム分析** — プロンプトとコードは最小限のレイテンシでリアルタイムにスキャンされます
- **エンタープライズ制御** — 有効化された組織では、利用可否とポリシー適用を管理できます
