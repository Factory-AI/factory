...
<Note>
The __PRESERVE_42__ format is a deprecated alias for __PRESERVE_43__ and works identically.
</Note>
...
<Note>
Reasoning effort (__PRESERVE_59__ / __PRESERVE_60__) is not yet supported for custom models, but coming soon.
</Note>
