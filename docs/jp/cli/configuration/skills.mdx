...
<Note>
**Custom slash commands have been merged into skills.** A file at __PRESERVE_6__ and a skill at __PRESERVE_7__ both create __PRESERVE_8__ and work the same way. Your existing __PRESERVE_9__ files keep working. Skills add optional features: a directory for supporting files, frontmatter to [control who can invoke them](#control-who-invokes-a-skill), and the ability for Droids to load them automatically when relevant.
</Note>
...
<Steps>
  <Step title="Create a skill folder">
    Under your repo, create a directory in __PRESERVE_47__, for example
    __PRESERVE_48__.
  </Step>
  <Step title="Add SKILL.md or skill.mdx">
    Inside the folder, create __PRESERVE_49__ or __PRESERVE_50__ with YAML frontmatter
    (__PRESERVE_51__, __PRESERVE_52__) and markdown instructions that define the
  ...
  <Step title="Add supporting files (optional)">
    ...
    skill is active (for example __PRESERVE_53__, __PRESERVE_54__, or
    __PRESERVE_55__).
  </Step>
  <Step title="Restart and use">
    Restart __PRESERVE_56__ or your integration so it rescans skills, then describe
