...
<Note>
  **Important**: Always use **absolute paths** when referencing scripts in your hook commands, not relative paths. 
  ...
  Use __PRESERVE_13__ for project-relative scripts (e.g., __PRESERVE_14__) 
  or full paths for global scripts (e.g., __PRESERVE_15__ or __PRESERVE_16__).
</Note>
...
<Note>You can use __PRESERVE_23__ to match all tools.</Note>
