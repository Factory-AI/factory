...
| `customModels` | モデル設定の配列 | `[]` | BYOK用のカスタムモデル設定。[BYOKドキュメント](/jp/cli/configuration/byok)を参照。 |
...
- **`gpt-5.4`** - GPT-5.4、922Kコンテキストとエクストラハイ推論機能付き最新OpenAIモデル
...
- [カスタムモデルとBYOK](/jp/cli/configuration/byok) - カスタムモデルとAPIキーの追加