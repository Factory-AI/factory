...
[仕様モードについて詳しく見る →](/cli/user-guides/specification-mode)
...
[自律性設定を構成する →](/cli/configuration/settings)
...
[モデル選択について学ぶ →](/cli/user-guides/choosing-your-model)
...
[設定ドキュメント全体 →](/cli/configuration/settings)
...
<AccordionGroup>
  ...
  <Accordion title="Droid Shield">
    ...
    [Droid Shieldについて詳しく見る →](/cli/account/droid-shield)
  </Accordion>
  ...
  <Accordion title="許可リストと拒否リスト">
    ...
    [自動実行設定について詳しく見る →](/cli/user-guides/auto-run)
  </Accordion>
</AccordionGroup>
...
[IDE連携について詳しく見る →](/cli/configuration/ide-integrations)
...
<Tip>
  詳しく見る: [設定](/cli/configuration/settings) | [カスタムスラッシュコマンド](/cli/configuration/custom-slash-commands) | [カスタムDroid](/cli/configuration/custom-droids) | [MCP設定](/cli/configuration/mcp)
</Tip>
...
<Steps>
  <Step title="プロバイダードキュメントを探す">
    [独自キーの使用ドキュメント](/cli/byok/overview)にアクセスし、プロバイダー（OpenRouter、Fireworksなど）を選択します
  </Step>
...
[すべてのBYOKプロバイダーを見る →](/cli/byok/overview)
...
[MCP設定について詳しく見る →](/cli/configuration/mcp)
...
[カスタムDroidについて詳しく見る →](/cli/configuration/custom-droids)
...
[すべてのMCPサーバーを見る →](/cli/configuration/mcp)
...
[仕様モードの完全ガイドを読む →](/cli/user-guides/specification-mode)

[大規模機能の実装について学ぶ →](/cli/user-guides/implementing-large-features)
