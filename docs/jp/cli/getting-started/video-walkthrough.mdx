...
<Note>
  **Terminal-specific key bindings**: The default for new lines is __PRESERVE_15__ + __PRESERVE_16__, but you can configure this to __PRESERVE_17__ or other combinations based on your terminal's key bindings. Check __PRESERVE_18__ in the CLI for configuration options.
</Note>
...
<Steps>
  ...
  <Step title="Add to config.json">
    Paste the configuration into __PRESERVE_40__ and add your API key
  </Step>
  
  <Step title="Select Model">
    Use __PRESERVE_41__ in the CLI to select your newly added model
  </Step>
</Steps>
...
<Steps>
  <Step title="Start in Spec Mode">
    Press __PRESERVE_51__ until you're in Spec mode
