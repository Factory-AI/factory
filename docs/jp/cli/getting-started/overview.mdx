...
<Note>
  **Quick tip:** Press __PRESERVE_4__ to toggle bash mode and run shell commands directly without AI interpretation. Press __PRESERVE_5__ to return to normal mode. See the [CLI Reference](/reference/cli-reference#bash-mode) for details.
</Note>
