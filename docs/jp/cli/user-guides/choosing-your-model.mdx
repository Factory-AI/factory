...
| 10   | **GPT-5.6 Sol** | **Max**推論、922K コンテキスト、verbosity サポートを備えた新しい OpenAI 主力モデル（GPT-5.6）；最も困難な作業に向けた OpenAI の最有力候補。2×価格設定。 |
| 11   | **GPT-5.6 Terra** | **Max**推論と 922K コンテキストを備え、1×価格設定で利用できるバランス型の GPT-5.6；強力な汎用 OpenAI オプション。 |
| 12   | **GPT-5.6 Luna** | 0.4×価格設定のコスト効率に優れた GPT-5.6 で、最大 **Max** までの推論と 922K コンテキストに対応；大量の OpenAI ワークロードに最適。 |
| 13   | **GPT-5.4** | 922K コンテキスト、128K 出力、verbosity サポート、**Extra High**推論を持つ最新の OpenAI モデル；大規模コンテキストのタスクに優秀。 |
| 14   | **Claude Sonnet 4.5** | コストと品質のバランスが取れた強力な日常向けモデル；Opus レベルの深さが不要な場合に優れた汎用選択肢。 |
| 15   | **GPT-5.3-Codex** | **Extra High**推論と verbosity サポートを持つ最新の OpenAI コーディングモデル；実装中心のタスクに強い。 |
| 16   | **GPT-5.2-Codex** | **Extra High**推論を持つ実績のある OpenAI コーディングモデル；実装中心のタスクに堅実。 |
| 17   | **GPT-5.2** | verbosity サポートと最大 **Extra High** までの推論を備えた OpenAI モデル。 |
| 18   | **Claude Haiku 4.5** | ルーチンタスクや大量自動化向けに高速でコスト効率が高い。 |
| 19   | **Gemini 3.1 Pro** | 構造化出力に強く、リサーチ集約型タスク向けに混合推論制御を備えた新しい Gemini Pro 世代。 |
| 20   | **Gemini 3 Flash** | 高速で低コスト（0.2×価格設定）かつ完全な推論サポート付き；スピードが重要な大量タスクに最適。 |
| 21   | **Droid Core (NVIDIA Nemotron 3 Ultra)** | オープンソース、0.4×価格設定、高頻度の自動化向けに高速でコスト効率の高いモデル；画像サポートなし。 |
| 22   | **Droid Core (MiniMax M3)** | オープンソース、マルチモーダルな画像サポートと強力な agentic 機能を備えた 0.12×価格設定；拡張コンテキストを活かせる日常タスク向けの信頼できる主力モデル。 |
| 23   | **Droid Core (MiniMax M2.7)** | オープンソース、推論サポート（Low/Medium/High）と画像サポート付きの 0.12×価格設定；利用可能な中で最も安価なモデル。 |
| 24   | **Droid Core (GLM-5.2)** | オープンソース、0.55×価格設定、大量自動化とエアギャップ環境向けの最新の GLM オプション；画像サポートなし。 |
| 25   | **Droid Core (GLM-5.1)** | オープンソース、0.55×価格設定、大量自動化とエアギャップ環境向けの新しい GLM オプション；画像サポートなし。 |
| 26   | **Droid Core (GLM-5)** | オープンソース、0.4×価格設定、大量自動化とエアギャップ環境向けの安定した選択肢；画像サポートなし。 |
| 27   | **Droid Core (Kimi K2.7 Code)** | コーディング特化の Kimi で、0.4×価格設定かつ任意の High 推論に対応；コスト重視の開発作業で強力な agentic 性能とツール使用能力を発揮。 |
| 28   | **Droid Core (Kimi K2.6)** | オープンソース、画像サポートと任意の High 推論付き 0.4×価格設定；思考トグルも欲しいコスト重視の作業に適している。 |
| 29   | **Droid Core (Kimi K2.5)** | オープンソース、画像サポート付き 0.25×価格設定；コスト重視の作業向けの旧 Kimi オプション。 |
...
<sup>†</sup> 2026年6月12日時点で、Claude Fable 5 は現在利用できません。詳細は Mythos アクセスに関する Anthropic の更新情報を[こちら](https://www.anthropic.com/news/fable-mythos-access)で確認してください。
...
| シナリオ                                                         | 推奨モデル                                                                                                                          |
| ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| **深い計画立案、アーキテクチャレビュー、曖昧な製品仕様** | 最高の深度と安全性のため**Opus 4.8**から始めるか、より高速な処理のため**Opus 4.7** / **Opus 4.6**にフォールバック。バランスの取れたコスト/品質なら**Sonnet 4.6**または**Sonnet 4.5**、大規模コンテキスト推論なら**GPT-5.4**を使用。 |
...
<Tip>
  **Claude Opus 4.8**は、極めて複雑なアーキテクチャの決定や最大限の推論能力が必要な重要な作業に向けた最新の最上位オプションです。**Claude Opus 4.7**と**Claude Opus 4.6**も引き続き優れた代替候補であり、**Opus 4.6 Fast**はより高いコストでより高速な応答向けに調整されています。ほとんどのタスクはOpusレベルのパワーを必要としません—Sonnet 4.6またはSonnet 4.5から始めて、必要な場合のみエスカレートしてください。
</Tip>
...
- **GPT-5.6 Sol / Terra / Luna**: None / Low / Medium / High / **Extra High** / **Max**（デフォルト：Medium）
...
- **Droid Core (GLM-5.2)**: Off / High（デフォルト：High；画像サポートなし）
...
推論努力は遅延とコストを増加させます—シンプルな作業では低めから始めて、必要に応じてエスカレートしてください。**Max**は GPT-5.6 ファミリー（Sol、Terra、Luna）、Claude Opus 4.8、Claude Opus 4.7、Opus 4.6 ファミリー（Opus 4.6 と Opus 4.6 Fast）、および Sonnet 4.6 で利用可能です。**Extra High**は GPT-5.6 ファミリー（Sol、Terra、Luna）、GPT-5.4、GPT-5.2、GPT-5.2-Codex、および GPT-5.3-Codex で利用可能です。
...
**Droid Core (GLM-5.2)**、**Droid Core (GLM-5)**、**Droid Core (GLM-5.1)**、**Droid Core (Kimi K2.6)**、**Droid Core (Kimi K2.5)**、および**Droid Core (MiniMax M2.7)**は、CLIで利用可能なオープンソースの代替案です。これらは以下に有用です：
...
**注意：** GLM-5、GLM-5.1、GLM-5.2は画像添付をサポートしていません。Kimi K2.5、Kimi K2.6、およびMiniMax M2.7は画像をサポートしています。Kimi K2.6にはOff/High推論切り替えが追加され、MiniMax M2.7（0.12×価格設定で利用可能な最安モデル）はLow/Medium/High推論をサポートしています。画像ベースのワークフローには、Claude、GPT、Kimi、またはMiniMax M2.7を使用してください。
