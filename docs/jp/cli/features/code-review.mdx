...
<Steps>
  ...
  <Step title="Configure parameters">
    ...
    - For **base branch reviews**: Select the target branch (e.g., __PRESERVE_12__, __PRESERVE_13__)
...
<AccordionGroup>
  ...
  <Accordion title="Integration with workflows">
    The __PRESERVE_14__ command is interactive and meant for CLI sessions. For automated reviews in CI/CD, use:
    __PRESERVE_5__
