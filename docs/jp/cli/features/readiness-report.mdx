...
すべての準備状況レポートは自動的に保存され、[web dashboard](/web/agent-readiness/dashboard) で表示できます。これにより以下が可能になります：
...
<Tip>
  Run __PRESERVE_10__ periodically (e.g., after major infrastructure
