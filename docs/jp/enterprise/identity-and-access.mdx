...
<CardGroup cols={2}>
  ...
  <Card title="Org / project / folder" icon="folders">
    The active repo and __PRESERVE_0__ folders determine the **org, project, and
...
<AccordionGroup>
  ...
  <Accordion title="Workspace trust">
    ...
    - Use project‑level __PRESERVE_7__ folders to mark which repos are "Droid‑ready" and what policies should apply.
