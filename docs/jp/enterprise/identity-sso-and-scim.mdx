...
- Add domains to verify (e.g., __PRESERVE_3__)
...
<Tip>
  ...
  __PRESERVE_12__ or __PRESERVE_13__ help you organize
  permissions by team.
</Tip>
...
3. Select which groups to sync (e.g., only __PRESERVE_14__ groups)
