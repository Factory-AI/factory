...
<Warning>
  Enabling __PRESERVE_12__ may expose sensitive information in publicly
...
<AccordionGroup>
  <Accordion title="For security‑conscious organizations">
    1. **Use repository secrets** – Store __PRESERVE_13__ as a repository or organization secret.
    2. **Review workflow permissions** – Ensure the workflow file requests only necessary permissions.
    3. **Restrict bot access** – Keep __PRESERVE_14__ empty unless you have a specific need.
    ...
    6. **Consider network restrictions** – Use __PRESERVE_15__ to limit network access.
  </Accordion>
