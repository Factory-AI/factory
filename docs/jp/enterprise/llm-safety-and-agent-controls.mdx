...
<AccordionGroup>
  <Accordion title="Block direct git pushes">
    Require all code changes to flow through your existing tooling by blocking __PRESERVE_12__ in Droid sessions and instructing developers to use internal CL/PR tooling instead.
  </Accordion>
