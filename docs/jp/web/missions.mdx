...
While you can run Missions from the CLI, the Factory Desktop and Web applications provide a rich, visual Mission Control dashboard. This interface is designed to help you act as a project manager—giving you complete visibility into the orchestrator and allowing you to steer workers visually.
