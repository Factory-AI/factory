...
<Note>
    See the Droid Exec setup [here](/jp/cli/droid-exec/overview#installation).
</Note>
...
- [Droid Exec Overview](/jp/cli/droid-exec/overview) - 自律性レベルと機能
- [GitHub Actions Cookbook](/jp/guides/droid-exec/github-actions) - より多くのワークフロー例
- [Documentation Sync Hooks](/jp/guides/hooks/documentation-sync) - 予防的アプローチ