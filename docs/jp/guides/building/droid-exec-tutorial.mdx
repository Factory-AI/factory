...
description: "Droid Execを使って「Xとチャット」機能を構築する方法を学ぶ"
---

<iframe
  className="w-full aspect-video rounded-xl"
  src="https://youtube.com/embed/pd8fWTwJylw"
  title="Droid Execでインタラクティブアプリを構築"
  frameBorder="0"
...
<Note>
  Droid Exec機能の完全なリファレンスは、[Droid Exec概要](/cli/droid-exec/overview)を参照してください
</Note>
...
<Note>
  すべてのフラグの説明は[CLIリファレンス](/reference/cli-reference)を参照してください
</Note>
