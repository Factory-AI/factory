...
<Note>
Plugin hooks cannot be imported via __PRESERVE_55__. They only function within installed plugins where the plugin root path can be resolved.
</Note>
