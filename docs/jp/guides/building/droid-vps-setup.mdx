...
- **Factory CLIのローカルインストール** - [installation guide](/cli/getting-started/quickstart)に従ってください
...
<Note>droid execの完全なドキュメントは[こちら](/cli/droid-exec/overview)を参照してください。</Note>
...
詳細情報：
- [Factory CLIドキュメント](/cli/getting-started/overview)
- [Droid Execリファレンス](/cli/droid-exec/overview)
- [カスタムDroidガイド](/cli/configuration/custom-droids)
