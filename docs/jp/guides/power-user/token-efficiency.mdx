...
| モデル | 倍率 | 最適用途 |
|-------|------------|----------|
| Droid Core (MiniMax M2.7) | 0.12× | 推論サポート付きの低コストMiniMaxオプション |
| Gemini 3 Flash | 0.2× | 大量タスク向けの高速・安価 |
| Droid Core (Kimi K2.6) | 0.25× | コスト重視の作業、画像サポート、High推論切り替え |
...
| Droid Core (GLM-5.1) | 0.4× | バルク自動化とエアギャップ環境向けの更新版GLMオプション |
