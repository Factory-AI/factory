...
<Info>
  **Factory Appを使用していますか？**これらの戦略はCLIと[Factory App](/jp/web/getting-started/overview)の両方に適用されます。[Agent Readinessダッシュボード](/jp/web/agent-readiness/dashboard)でプロジェクトの準備状況スコアを確認できます。
</Info>
