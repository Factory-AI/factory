...
<Tip>
  **Enforce rules automatically:** Use [PostToolUse hooks](/jp/cli/configuration/hooks-guide) to run linters after edits. See [Hooks reference](/jp/reference/hooks-reference) for examples.
</Tip>
