...
<Tabs>
  <Tab title="# prefix trigger">
    Trigger with __PRESERVE_23__ at the start of your message for quick capture.
    
    **Usage:**
    - "#we use the repository pattern"
    - "##I prefer early returns" (double __PRESERVE_24__ for personal)
...
すぐに使用できる実装については、[memory-capture skill example](https://github.com/Factory-AI/factory/tree/main/examples/power-user-skills/memory-capture)を参照してください。
