...
<Steps>
  ...
  <Step title="Copy scripts and package metadata">
    Copy __PRESERVE_30__, __PRESERVE_31__, __PRESERVE_32__, __PRESERVE_33__, __PRESERVE_34__, and
    __PRESERVE_35__ into __PRESERVE_36__ (or symlink to a shared
    dotfiles repo).
  </Step>
  <Step title="Install dependencies">
    Run __PRESERVE_37__, then
    __PRESERVE_38__.
  </Step>
  <Step title="Restart Droid">
    Restart __PRESERVE_39__ (or your IDE integration) so it rescans workspace skills and
    discovers __PRESERVE_40__.
  </Step>
</Steps>
