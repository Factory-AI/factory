...
<CardGroup cols={2}>
  ...
  <Card title="3 · Add custom commands" icon="toolbox" href="/user-guides/remote-workspaces/custom-commands">
    Add custom commands to run during workspace creation.
  </Card>

  <Card title="4 · Follow Best Practices" icon="lightbulb" href="/user-guides/remote-workspaces/best-practices">
    Optimize performance, cost, and team workflows with proven tips.
  </Card>

  <Card title="5 · Troubleshoot Like a Pro" icon="bug" href="/user-guides/remote-workspaces/troubleshooting">
