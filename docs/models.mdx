...
## <span className="provider-heading"><img src="/images/model-icons/anthropic.png" alt="Anthropic logo" className="provider-icon anthropic-icon" />Anthropic</span>
...
## <span className="provider-heading"><img src="/images/model-icons/openai.svg" alt="OpenAI logo" className="provider-icon openai-icon" />OpenAI</span>
...
## <span className="provider-heading"><img src="/images/model-icons/google.ico" alt="Google logo" className="provider-icon" />Google</span>
...
## <span className="provider-heading"><img src="/favicon.svg" alt="Factory logo" className="provider-icon factory-icon" />Droid Core (Open Models)</span>
