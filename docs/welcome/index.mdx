...
import { ProductName } from '/snippets/vars.mdx';

<img
  src="/images/desktop-app-preview.png"
  alt="Factory App with Droid sessions, chat, and code editor"
  style={{ width: "100%", height: "auto" }}
  className="rounded-lg"
/>

<ProductName variant="factory" /> is an AI-native software development platform that works everywhere you do. Use this page to pick the right starting point, then drill into the capability, configuration, and enterprise docs that match your workflow.

## Start with your surface

<CardGroup cols={2}>
  <Card title="Droid CLI" icon="square-terminal" href="/cli/getting-started/quickstart">
    Run <ProductName variant="droid" /> in your terminal and get productive in minutes.
  </Card>
  <Card title="Factory App" icon="browser" href="/web/getting-started/quickstart">
    Download the <ProductName variant="factoryApp" /> and connect <ProductName variant="droid" /> to your local machine.
  </Card>
  <Card title="Droid Exec" icon="terminal" href="/cli/droid-exec/overview">
    Run <ProductName variant="droid" /> non-interactively in CI/CD and automation workflows.
  </Card>
...
<CardGroup cols={2}>
  <Card title="Factory Missions" icon="diagram-project" href="/cli/features/missions">
...
<CardGroup cols={2}>
  <Card title="Common Use Cases" icon="lightbulb" href="/cli/getting-started/common-use-cases">
    See practical workflows you can run right away in the Droid CLI.
  </Card>
  <Card title="Droid CLI Reference" icon="terminal" href="/reference/cli-reference">
    Browse commands, flags, and operational details for <ProductName variant="droid" />.
  </Card>
