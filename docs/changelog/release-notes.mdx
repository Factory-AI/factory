...
<Update label="June 15" rss={{ title: "CLI Updates", description: "AGENTS.md instruction support and a Canva MCP authentication fix" }}>
  `v0.149.0`

## Improvements

- **AGENTS.md support** - Droid now picks up agent instructions from `AGENTS.md` files in your project
