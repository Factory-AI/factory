...
<Update label="April 8" rss={{ title: "CLI Updates", description: "Droid Core GLM-5.1 model" }}>
  `v0.96.2`

## New features

- **Droid Core (GLM-5.1) model** - Added Droid Core GLM-5.1 with expanded output capacity, replacing GLM-5 as the default Droid Core model in the model selector
