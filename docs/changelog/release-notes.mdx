...
<Update label="April 1" rss={{ title: "CLI Updates", description: "Unified missions menu, settings and footer redesign, session forking, TUI charts, and SSH clipboard fixes" }}>
  `v0.92.0`
...
- **Status indicator accuracy** - Status now correctly shows "Thinking" instead of "Executing" when the model is reasoning after tool use
