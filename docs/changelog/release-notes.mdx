...
- **Delete AutoWiki runs** - You can now delete AutoWiki runs directly from the Factory App
...
- **Factory App stability** - Improved crash reporting and shutdown handling in the Factory App
