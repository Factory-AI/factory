...
- **Delete AutoWiki runs** - You can now delete AutoWiki runs directly from the Factory App (app)
...
- **AutoWiki history dropdown** - AutoWiki history dropdown is no longer cut off by the surrounding layout (app)
...
- **Bulk Usage Limit updates** - Admins can update Usage Limits for multiple users at once (app)
...
- **AutoWiki export validation** - Hardened filename validation when exporting AutoWiki documentation (app)
...
- **AutoWiki UI polish** - Visual refinements across the AutoWiki interface (app)
...
- **System theming** - Factory App now follows your system theme (app)
- **New Factory App updater** - Improved auto-update flow for the Factory App (app)
...
- **Factory App stability** - Improved crash reporting and shutdown handling in the Factory App (app)
...
- **Usage Limit warning** - Warning banner now shown when setting a global Usage Limit (app)
...
- **AutoWiki search and exports** - AutoWiki now supports keyword search, skill browsing, and page exports (app)
...
- **BYOK Rate Limits** - BYOK users can now continue chatting when platform Rate Limits are reached (app)
...
- **macOS Spotlight discoverability** - Factory App is now easier to find via macOS Spotlight search (app)

## Improvements

- **Install QA skill upgrade** - The install-qa skill now learns from test failures to improve over time
- **Faster AutoWiki loading** - Optimized AutoWiki page loading for reduced latency (app)
...
- **Pre-session bug reports** - Submit bug reports from the Factory App even when no session is active (app)
...
- **Factory App UI polish** - Various visual refinements across the Factory App (app)
...
- **Rate Limit countdown** - Live countdown timer shows remaining Rate Limits in real-time (app)
...
- **Factory Missions mode input** - Fixed input field behavior in Factory Missions mode (app)
...
- **Faster Factory App session loading** - Sessions load directly from disk in the Factory App for improved speed (app)
...
- **Billable Tokens renamed to Factory Standard Credits** - "Billable Tokens" renamed to "Factory Standard Credits" throughout the app UI (app)
...
- **AutoWiki sidebar polish** - Improved AutoWiki sidebar design with smoother pan transitions (app)
...
- **Usage Limits settings UI** - New interface for viewing and managing Usage Limits settings (app)
...
- **Code server connection** - Fixed code server connection issues in the Factory App (app)
...
- **Factory App download button** - Fixed download Factory App button incorrectly showing in the Factory App (app)
...
- **Usage Limits settings** - Configure and view Usage Limits directly within sessions and settings (app)

## Bug fixes

- **VS Code auto-installation** - Fixed embedded VS Code auto-installation in the Factory App (app)
- **Factory App stability** - Fixed daemon restart issues in the Factory App (app)
...
- **Payment redirect on desktop** - Fixed payment page redirect handling in the Factory App (app)
...
- **Factory App version display** - Factory App now shows the current version number (app)
...
- **User Usage Limits modal** - Fixed scroll bug in the Individual User Usage Limits modal (app)
...
- **Factory App connection race** - Fixed daemon connection race condition in the Factory App with polling retry logic (app)
- **Sidebar sessions** - Fixed sessions disappearing from sidebar (app)
- **Open in editor** - Fixed "open in editor" functionality in the Factory App (app)
...
- **Factory App notifications** - Native macOS and Windows notifications when sessions complete, with configurable preferences (app)
- **Factory App native view redesign** - Refreshed sidebar layout with smooth animations, new terminal editor icons, and keyboard shortcut formatting (app)
...
- **Ask User tool** - Ask User tool now available in the web and Factory App surfaces (app)
...
- **Task tool live streaming** - Real-time subagent tool progress display and Execute tool output streaming in web and Factory App surfaces (app)
