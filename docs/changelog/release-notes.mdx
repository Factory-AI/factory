...
- **Spec handoff savings calculation** - Corrected the context savings percentage shown after a spec handoff
...
- **Org model policy enforcement** - Org model policies are now properly enforced on session resume and default healing
