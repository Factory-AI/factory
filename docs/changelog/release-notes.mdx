...
- **Members settings page** - New page for organization admins to manage teammates (app)
- **Billing address at checkout** - Subscriptions now require a billing address at checkout (app)
...
- **Usage buckets in your timezone** - Usage buckets now align to your local timezone (app)
...
- **Managed settings on non-enterprise orgs** - Non-enterprise organizations no longer see fabricated managed settings
...
- **Individual plan page polish** - Minor fixes to the Individual plan page (app)
