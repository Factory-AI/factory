...
<Update label="May 7" rss={{ title: "CLI Updates", description: "Maintenance release with stability improvements" }}>
  `v0.120.1`

## Improvements

- **Stability release** - Rolled back recent changes to address stability issues; no user-facing feature changes
