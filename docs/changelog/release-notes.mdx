...
<Update label="April 7" rss={{ title: "CLI Updates", description: "New Computers API for managing persistent computer environments" }}>

## New features

- **Computers API** - New public API for managing Droid Computers with streamlined endpoints for listing, looking up by name, deleting, and restarting persistent computer environments
