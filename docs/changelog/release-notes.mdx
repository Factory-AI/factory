...
import { DocsURL } from '/snippets/vars.mdx';
...
- **Execute tool name display** - Fixed the Execute tool name being truncated in pending state
...
- Updated Opus 4.5 pricing with dismissible notice
...
- **MCP Revamp**: Complete overhaul of Model Context Protocol implementation (<DocsURL path="/cli/configuration/mcp">docs updated</DocsURL>)
