...
- **Warmup message loop** - Fixed an issue where warmup messages could repeat endlessly
...
- **Inactivity timeout settings** - Fixed inactivity timeout settings not being applied correctly
