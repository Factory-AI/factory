...
<Update label="May 15" rss={{ title: "CLI Updates", description: "Wrong-region recovery and stability fixes" }}>
  `v0.128.0`

## Bug fixes

- **Wrong-region recovery** - The wrong-region page now surfaces logout and identity details so you can resolve account mismatches without leaving the app (app)
