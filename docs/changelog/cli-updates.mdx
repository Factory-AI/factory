...
<Update label="November 10" rss={{ title: "CLI Updates", description: "Markdown tables, pinned todos, and model improvements" }}>
  `v0.23.0`
  ...
  * Fixed baseline version detection in auto-update process to prevent reverting to non-baseline builds
