...
import { vars, ProductName, InstallCommand } from '/snippets/vars.mdx';

## Installation

**macOS/Linux:** <code><InstallCommand platform="macos" /></code>

**Windows:** <code><InstallCommand platform="windows" /></code>

The <ProductName variant="droidCli" /> operates in two modes:
...
| `Ctrl+P`          | Toggle the blog post viewer                                                     |
...
1. Generate an API key in the <a href={`${vars.urls.app}/settings/api-keys`}>Factory API keys settings</a>
...
- [Quickstart guide](/cli/getting-started/quickstart) - Getting started with the <ProductName variant="droidCli" />
