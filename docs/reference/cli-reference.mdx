...
| `--disable-builtin-skills`        | Disable Factory-provided builtin skills for this session while preserving other skill sources | `droid exec --disable-builtin-skills "analyze this repo"` |
