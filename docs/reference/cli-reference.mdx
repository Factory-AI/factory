...
| `/missions`       | Enter Factory Missions                                         |
...
| `/missions`            | List and select Factory Missions to resume                     |
...
- [Quickstart guide](/cli/getting-started/quickstart) - Getting started with Droid CLI
