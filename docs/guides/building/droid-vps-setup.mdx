...
- Set up Droid CLI on a Virtual Private Server (VPS) for remote access from anywhere
...
- **Droid CLI installed locally** - Follow the [installation guide](/cli/getting-started/quickstart)
