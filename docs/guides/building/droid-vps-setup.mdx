...
import { vars, InstallCommand, ProductName, DiscordInvite } from '/snippets/vars.mdx';
...
- Set up the Droid CLI on a Virtual Private Server (VPS) for remote access from anywhere
...
- **The Droid CLI is installed locally** - Follow the [installation guide](/cli/getting-started/quickstart)
- **Factory account** - Sign up at <a href={vars.urls.factory}>factory.ai</a>
...
Install the <ProductName variant="droidCli" /> on the VPS with <code><InstallCommand platform="macos" /></code>.
...
4. **Join the community**: Share your use cases and learn from others in the <DiscordInvite>Factory Discord</DiscordInvite>

For more information:
- [Droid CLI documentation](/cli/getting-started/overview)
