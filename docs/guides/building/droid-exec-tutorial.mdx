...
import { DiscordInvite, InstallCommand, ProductName, vars } from '/snippets/vars.mdx';
...
- The <ProductName variant="droidCli" /> on your PATH (`droid`)
...
Install the <ProductName variant="droidCli" /> with <code><InstallCommand platform="macos" /></code>.
...
**Official Example:**
- <a href={`${vars.urls.github.org}/examples/tree/main/droid-chat`}>GitHub: droid-chat example</a> - Full working code
...
**Community:**
- <DiscordInvite>Factory Discord</DiscordInvite> - Get help from the team
