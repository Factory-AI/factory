...
<Info>
  **Using Factory App?** These strategies apply to both the Droid CLI and the [Factory App](/web/getting-started/overview). You can view your project's readiness score in the [Agent Readiness Dashboard](/web/agent-readiness/dashboard).
</Info>
...
See [Available Models](/models) for current model multipliers.
