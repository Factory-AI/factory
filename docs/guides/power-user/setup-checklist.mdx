...
<Info>
  **Using Factory App?** Most of this guide applies to both Droid CLI and [Factory App](/web/getting-started/overview). Where the experience differs, we've noted the Factory App-specific approach.
</Info>
...
<Tip>
  **Enforce rules automatically:** Use [PostToolUse hooks](/cli/configuration/hooks-guide) to run linters after edits. See [Code Validation hooks](/reference/hooks-reference) for examples.
</Tip>
