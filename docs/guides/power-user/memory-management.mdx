...
<Info>
  **Works with Factory App:** These memory patterns work identically in both Droid CLI and [Factory App](/web/getting-started/overview)—just ensure your working directory is set to your repository root.
</Info>
