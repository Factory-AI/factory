...
<Accordion title="Project context loader">
...
<Accordion title="Environment setup hook">
...
<Accordion title="Issue context loader">
...
<Accordion title="Dependency checker">
...
<Accordion title="Project guidelines loader">
...
<Accordion title="Branch-aware context">
...
<Accordion title="Monorepo context">
...
<Accordion title="Docker service checker">
...
<AccordionGroup>
  <Accordion title="Context too verbose">
  ...
  <Accordion title="Hook runs too slowly">
