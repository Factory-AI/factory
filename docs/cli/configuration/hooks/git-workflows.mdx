...
<Accordion title="Commit message validator">
...
<Accordion title="Branch protection hook">
...
<Accordion title="Branch naming validator">
...
<Accordion title="Changelog generator">
...
<Accordion title="Pre-push validator">
...
<Accordion title="Auto PR creation">
...
<Accordion title="Co-author enforcement">
...
<Accordion title="Monorepo commit scope validator">
...
<Accordion title="Auto-tagging on version bump">
...
<AccordionGroup>
  <Accordion title="Hook blocks legitimate commits">
  ...
  <Accordion title="Conflicts with Git hooks">
  ...
  <Accordion title="Pre-push checks too slow">
...
- [Hooks reference](/cli/configuration/hooks-reference) - Complete hooks API documentation
