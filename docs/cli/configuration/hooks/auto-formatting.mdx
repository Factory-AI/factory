...
<Accordion title="TypeScript/JavaScript formatter hook">
```json
{
  "hooks": {
    "PostToolUse": [
...
<Accordion title="Multi-language formatter script">
...
<Accordion title="Custom prettier config hook">
```json
{
  "hooks": {
    "PostToolUse": [
...
<Accordion title="Format and lint hook">
...
<Accordion title="Conditional formatting by directory">
...
<AccordionGroup>
  ...
  <Accordion title="Formatting breaks code">
  ...
  <Accordion title="Conflicts with editor formatting">
