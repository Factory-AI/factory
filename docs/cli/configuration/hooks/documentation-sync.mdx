...
<Accordion title="API docs generator">
...
<Accordion title="README updater">
...
<Accordion title="Example synchronizer">
...
<Accordion title="OpenAPI validator">
...
<Accordion title="Documentation comment enforcer">
...
<Accordion title="Documentation coverage reporter">
...
<AccordionGroup>
  <Accordion title="Doc generation fails">
  ...
  <Accordion title="Examples out of sync">
  ...
  <Accordion title="Docs build too slow">
