...
<Accordion title="File protection hook">
...
<Accordion title="TypeScript validation hook">
...
<Accordion title="Secret scanning hook">
...
<Accordion title="Dependency vulnerability check">
...
<Accordion title="Comprehensive linter hook">
...
<Accordion title="Code complexity validator">
...
<Accordion title="Business logic validator">
...
<Accordion title="Architecture validator">
...
<AccordionGroup>
  ...
  <Accordion title="Validation too slow">
  ...
  <Accordion title="Inconsistent with CI">
