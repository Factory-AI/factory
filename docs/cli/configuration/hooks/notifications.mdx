...
<Accordion title="Cross-platform desktop notification">
...
<Accordion title="Task completion sound">
...
<Accordion title="Slack notification on completion">
...
<Accordion title="Email notification on errors">
...
<Accordion title="macOS rich notifications">
...
<Accordion title="Generic webhook notification">
...
<Accordion title="Smart notification based on idle time">
...
<Accordion title="Team event logger">
...
<AccordionGroup>
  ...
  <Accordion title="Slack webhook fails">
