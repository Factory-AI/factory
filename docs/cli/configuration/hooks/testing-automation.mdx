...
<Accordion title="Auto-test runner">
...
<Accordion title="Coverage checker">
...
<Accordion title="Test existence validator">
...
<Accordion title="Smart test runner">
...
<Accordion title="Snapshot validator">
...
<Accordion title="Test performance monitor">
...
<Accordion title="Flaky test detector">
...
<AccordionGroup>
  <Accordion title="Tests too slow">
  ...
  <Accordion title="False test failures">
  ...
  <Accordion title="Coverage calculation wrong">
