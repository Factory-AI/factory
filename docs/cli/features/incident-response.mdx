...
<Steps>
  ...
  <Step title="Choose Account and Computer">
    ...
    - **Run on** sets the computer where Droid investigates. Pick the computer with the right repositories, observability tools, and anything else you want to add that can help the agent.
  </Step>
