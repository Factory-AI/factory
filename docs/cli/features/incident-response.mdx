...
Droid can work toward an RCA, open a PR for a fix when appropriate, and update a local incident runbook so future investigations of the same alert type start faster.
