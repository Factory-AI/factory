...
The AutoWiki view in the <ProductName variant="factoryApp" /> at <a href={`${vars.urls.app}/wiki`}>app.factory.ai/wiki</a> lets you browse, search, and manage generated Wikis for all your repositories in one place.
...
From the top-level AutoWiki page at <a href={`${vars.urls.app}/wiki`}>app.factory.ai/wiki</a>, you can refresh multiple repositories at once:
