...
<Card title="Architecture deep dive" href={`${vars.urls.github.repo.plugins}/blob/master/plugins/droid-control/ARCHITECTURE.md`} icon="sitemap">
...
<CardGroup cols={2}>
  <Card title="Source code" href={`${vars.urls.github.repo.plugins}/tree/master/plugins/droid-control`} icon="github">
  ...
  <Card title="README" href={`${vars.urls.github.repo.plugins}/blob/master/plugins/droid-control/README.md`} icon="book-open">
