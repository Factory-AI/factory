---
title: "Complete Walkthrough (Video)"
description: "Follow along with a comprehensive video tutorial covering installation, configuration, and all key features of the Droid CLI"
---

Watch this complete walkthrough to learn everything you need to know about using the Droid CLI, from basic installation to advanced configuration.

<iframe
  width="100%"
  height="450"
  src="/Users/bentossell/Desktop/factory-demos/getting started overview_final.mp4"
  title="Getting Started with Droid CLI - Complete Walkthrough"
  frameBorder="0"
...
<Note>
  This 8-minute video covers the complete Droid CLI experience. Feel free to follow along or use the sections below as a reference guide.
</Note>
...
1. View available models (e.g., Codex, Claude Sonnet, GPT-4)
2. Switch between models for different tasks
3. Set reasoning level where applicable (e.g., for o1 models)
...
- **Import** (`i`) - Import pre-built droids from explored agents
