...
<Check>
  <li>Import groups clearly labeled with comments</li>
  <li>External packages separated from relative imports</li>
  <li>Alphabetical sorting within each import group</li>
  <li>Verification that all imports are actually used</li>
  <li>Consistent formatting and code style maintained</li>
</Check>
