...
<Steps>
  ...
  <Step title="Test on critical paths first">
    Start with user-facing API routes for maximum impact: 
    ```bash # Improve errors in API routes first 
    ./droid-improve-errors.sh apps/factory-app/src/app/api # Then expand to services
