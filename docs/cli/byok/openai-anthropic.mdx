...
- **Cost Control**: Direct billing from providers without Factory markup
- **Usage Transparency**: Monitor usage directly in provider dashboards
- **Rate Limits**: Use your own rate limits and quotas
- **Prompt Caching**: Automatic prompt caching support for reduced costs
