...
| 10   | **GPT-5.6 Sol**                          | New OpenAI flagship (GPT-5.6) with **Max** reasoning, 922K context, and verbosity support; top OpenAI pick for the hardest work. 2× multiplier.             |
| 11   | **GPT-5.6 Terra**                        | Balanced GPT-5.6 with **Max** reasoning and 922K context at a 1× multiplier; strong general-purpose OpenAI option.                                          |
| 12   | **GPT-5.6 Luna**                         | Cost-efficient GPT-5.6 at 0.4× with reasoning up to **Max** and 922K context; great for high-volume OpenAI work.                                            |
| 13   | **GPT-5.4**                              | Latest OpenAI model with 922K context, 128K output, verbosity support, and **Extra High** reasoning; excellent for large-context tasks.                     |
| 14   | **Claude Sonnet 4.5**                    | Strong daily driver with balanced cost/quality; great general-purpose choice when you don't need Opus-level depth.                                          |
| 15   | **GPT-5.3-Codex**                        | Newest OpenAI coding model with **Extra High** reasoning and verbosity support; strong for implementation-heavy tasks.                                      |
| 16   | **GPT-5.2-Codex**                        | Proven OpenAI coding model with **Extra High** reasoning; solid for implementation-heavy tasks.                                                             |
| 17   | **GPT-5.2**                              | OpenAI model with verbosity support and reasoning up to **Extra High**.                                                                                     |
| 18   | **Claude Haiku 4.5**                     | Fast, cost-efficient for routine tasks and high-volume automation.                                                                                          |
| 19   | **Gemini 3.1 Pro**                       | Newer Gemini Pro generation with strong structured outputs and mixed reasoning controls for research-heavy tasks.                                           |
| 20   | **Gemini 3 Flash**                       | Fast, cheap (0.2× multiplier) with full reasoning support; great for high-volume tasks where speed matters.                                                 |
| 21   | **Droid Core (NVIDIA Nemotron 3 Ultra)** | Open-source, 0.4× multiplier, fast and cost-efficient model for high-frequency automations; no image support.                                               |
| 22   | **Droid Core (MiniMax M3)**              | Open-source, 0.12× multiplier with multimodal image support and strong agentic capabilities; dependable workhorse for everyday tasks with extended context. |
| 23   | **Droid Core (MiniMax M2.7)**            | Open-source, 0.12× multiplier with reasoning support (Low/Medium/High) and image support; cheapest model available.                                         |
...
**Droid Core (GLM-5)**, **Droid Core (Kimi K2.6)**, **Droid Core (Kimi K2.5)**, and **Droid Core (MiniMax M2.7)** are open-source alternatives available in the CLI. They're useful for:
...
**Note:** GLM-5 does not support image attachments. Kimi K2.5, Kimi K2.6, and MiniMax M2.7 do support images. Kimi K2.6 adds an Off/High reasoning toggle, while MiniMax M2.7 (the cheapest model available, with 0.12× multiplier) supports Low/Medium/High reasoning. For image-based workflows, use Claude, GPT, Kimi, or MiniMax M2.7.
