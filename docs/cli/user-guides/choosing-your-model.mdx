...
This guide was last updated on Wednesday, June 3rd 2026.
...
| 7    | **Claude Opus 4.5**                      | Proven quality-and-safety balance; strong default for TUI and exec.                                                                                         |
| 8    | **Claude Sonnet 4.6**                    | **Max** reasoning at the Sonnet price point (1.2×); strong daily driver for planning and implementation.                                                    |
| 9    | **GPT-5.6 Sol**                          | New OpenAI flagship (GPT-5.6) with **Max** reasoning, 922K context, and verbosity support; top OpenAI pick for the hardest work. 2× multiplier.             |
| 10   | **GPT-5.6 Terra**                        | Balanced GPT-5.6 with **Max** reasoning and 922K context at a 1× multiplier; strong general-purpose OpenAI option.                                          |
| 11   | **GPT-5.6 Luna**                         | Cost-efficient GPT-5.6 at 0.4× with reasoning up to **Max** and 922K context; great for high-volume OpenAI work.                                            |
| 12   | **GPT-5.4**                              | Latest OpenAI model with 922K context, 128K output, verbosity support, and **Extra High** reasoning; excellent for large-context tasks.                     |
| 13   | **Claude Sonnet 4.5**                    | Strong daily driver with balanced cost/quality; great general-purpose choice when you don't need Opus-level depth.                                          |
| 14   | **GPT-5.3-Codex**                        | Newest OpenAI coding model with **Extra High** reasoning and verbosity support; strong for implementation-heavy tasks.                                      |
| 15   | **GPT-5.2-Codex**                        | Proven OpenAI coding model with **Extra High** reasoning; solid for implementation-heavy tasks.                                                             |
| 16   | **GPT-5.2**                              | OpenAI model with verbosity support and reasoning up to **Extra High**.                                                                                     |
| 17   | **Claude Haiku 4.5**                     | Fast, cost-efficient for routine tasks and high-volume automation.                                                                                          |
| 18   | **Gemini 3.1 Pro**                       | Newer Gemini Pro generation with strong structured outputs and mixed reasoning controls for research-heavy tasks.                                           |
| 19   | **Gemini 3 Flash**                       | Fast, cheap (0.2× multiplier) with full reasoning support; great for high-volume tasks where speed matters.                                                 |
| 20   | **Droid Core (NVIDIA Nemotron 3 Ultra)** | Open-source, 0.4× multiplier, fast and cost-efficient model for high-frequency automations; no image support.                                               |
| 21   | **Droid Core (MiniMax M3)**              | Open-source, 0.12× multiplier with multimodal image support and strong agentic capabilities; dependable workhorse for everyday tasks with extended context. |
| 22   | **Droid Core (MiniMax M2.7)**            | Open-source, 0.12× multiplier with reasoning support (Low/Medium/High) and image support; cheapest model available.                                         |
| 23   | **Droid Core (GLM-5.1)**                 | Open-source, 0.55× multiplier, newer GLM option for bulk automation and air-gapped environments; no image support.                                          |
...
| 25   | **Droid Core (Kimi K2.7 Code)**          | Coding-specialized Kimi at 0.4× with optional High reasoning; strong agentic and tool use for cost-sensitive dev work.                                      |
| 26   | **Droid Core (Kimi K2.6)**               | Open-source, 0.4× multiplier with image support and optional High reasoning; good for cost-sensitive work when you still want a thinking toggle.            |
| 27   | **Droid Core (Kimi K2.5)**               | Open-source, 0.25× multiplier with image support; older Kimi option for cost-sensitive work.                                                                |
...
<Tip>
  **Claude Opus 4.8** is the newest top-tier option for extremely complex architecture decisions or critical
  ...
  excellent alternatives. Most tasks don't require Opus-level power—start with Sonnet 4.6 or Sonnet 4.5
...
- **Opus 4.6**: Off / Low / Medium / High / **Max** (default: High)
...
Reasoning effort increases latency and cost—start low for simple work and escalate as needed. **Max** is available on the GPT-5.6 family (Sol, Terra, Luna), Claude Opus 4.8, Claude Opus 4.7, Claude Opus 4.6, and Sonnet 4.6. **Extra High** is available on the GPT-5.6 family (Sol, Terra, Luna), GPT-5.4, GPT-5.2, GPT-5.2-Codex, and GPT-5.3-Codex.
