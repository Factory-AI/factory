...
| 14   | **Droid Core (MiniMax M2.7)** | Newer MiniMax open-source model with image support and Low / Medium / High reasoning for cost-sensitive agentic workflows.                      |
