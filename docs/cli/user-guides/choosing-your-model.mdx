...
| 20   | **Droid Core (MiniMax M3)**              | Open-source, 0.12× multiplier with multimodal image support and strong agentic capabilities; dependable workhorse for everyday tasks with extended context. |
| 21   | **Droid Core (MiniMax M2.7)**            | Open-source, 0.12× multiplier with reasoning support (Low/Medium/High) and image support; cheapest model available.                                         |
| 22   | **Droid Core (GLM-5.1)**                 | Open-source, 0.55× multiplier, newer GLM option for bulk automation and air-gapped environments; no image support.                                          |
| 23   | **Droid Core (GLM-5)**                   | Open-source, 0.4× multiplier, stable choice for bulk automation and air-gapped environments; no image support.                                              |
