...
**Droid Core (GLM-5)**, **Droid Core (GLM-4.7)**, **Droid Core (Kimi K2.6)**, **Droid Core (Kimi K2.5)**, and **Droid Core (MiniMax M2.5)** are open-source alternatives available in the CLI. They're useful for:
...
**Note:** GLM-5, GLM-4.7, and MiniMax M2.5 do not support image attachments. Kimi K2.5 and Kimi K2.6 do support images. Kimi K2.6 also adds an Off/High reasoning toggle. MiniMax M2.5 is the cheapest model available (0.12× multiplier). For image-based workflows, use Claude, GPT, or Kimi models.
