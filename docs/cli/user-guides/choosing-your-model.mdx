...
| 14   | **Droid Core (MiniMax M2.7)** | Open-source, 0.12× multiplier with reasoning support (Low/Medium/High); cheapest model available.                      |
| 15   | **Droid Core (GLM-5.1)**      | Open-source, 0.55× multiplier with updated GLM capabilities; newer GLM option for bulk automation and air-gapped environments; no image support. |
