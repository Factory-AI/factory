...
| 2    | **Claude Opus 4.8 Fast Mode**            | Newest Anthropic flagship with **Max** reasoning; top pick for hardest work.                                                                     |
| 3    | **Claude Opus 4.7**                      | Anthropic flagship with **Max and Fast** reasoning; top pick for the hardest work. 2× multiplier.                                                |
| 4    | **Claude Opus 4.6**                      | Previous Anthropic flagship with **Max** reasoning; still excellent depth and safety for complex work.                                           |
| 5    | **Claude Opus 4.6 Fast**                 | Opus 4.6 tuned for faster response times; 12× multiplier.                                                                                        |
| 6    | **Claude Opus 4.5**                      | Proven quality-and-safety balance; strong default for TUI and exec.                                                                              |
| 7    | **Claude Sonnet 4.6**                    | **Max** reasoning at the Sonnet price point (1.2×); strong daily driver for planning and implementation.                                         |
| 8    | **GPT-5.4**                              | Latest OpenAI model with 922K context, 128K output, verbosity support, and **Extra High** reasoning; excellent for large-context tasks.          |
| 9    | **Claude Sonnet 4.5**                    | Strong daily driver with balanced cost/quality; great general-purpose choice when you don't need Opus-level depth.                               |
| 10   | **GPT-5.3-Codex**                        | Newest OpenAI coding model with **Extra High** reasoning and verbosity support; strong for implementation-heavy tasks.                           |
| 11   | **GPT-5.2-Codex**                        | Proven OpenAI coding model with **Extra High** reasoning; solid for implementation-heavy tasks.                                                  |
| 12   | **GPT-5.2**                              | OpenAI model with verbosity support and reasoning up to **Extra High**.                                                                          |
| 13   | **Claude Haiku 4.5**                     | Fast, cost-efficient for routine tasks and high-volume automation.                                                                               |
| 14   | **Gemini 3.1 Pro**                       | Newer Gemini Pro generation with strong structured outputs and mixed reasoning controls for research-heavy tasks.                                |
| 15   | **Gemini 3 Flash**                       | Fast, cheap (0.2× multiplier) with full reasoning support; great for high-volume tasks where speed matters.                                      |
| 16   | **Droid Core (NVIDIA Nemotron 3 Ultra)** | Open-source, 0.4× multiplier, fast and cost-efficient model for high-frequency automations; no image support.                                    |
| 17   | **Droid Core (MiniMax M2.7)**            | Open-source, 0.12× multiplier with reasoning support (Low/Medium/High) and image support; cheapest model available.                              |
| 18   | **Droid Core (GLM-5.1)**                 | Open-source, 0.55× multiplier, newer GLM option for bulk automation and air-gapped environments; no image support.                               |
| 19   | **Droid Core (GLM-5)**                   | Open-source, 0.4× multiplier, stable choice for bulk automation and air-gapped environments; no image support.                                   |
| 20   | **Droid Core (Kimi K2.6)**               | Open-source, 0.4× multiplier with image support and optional High reasoning; good for cost-sensitive work when you still want a thinking toggle. |
| 21   | **Droid Core (Kimi K2.5)**               | Open-source, 0.25× multiplier with image support; older Kimi option for cost-sensitive work.                                                     |

<sup>\*</sup> Fable 5 requires 30 day data retention for trust and safety models, please see more information [here](https://support.claude.com/en/articles/15425996-data-retention-practices-for-mythos-class-models).
