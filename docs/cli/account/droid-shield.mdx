...
import { SecurityLink, SupportLink } from '/snippets/vars.mdx';
...
3. **Report the pattern** - Contact <SupportLink /> if you encounter recurring false positives
...
<CardGroup cols={2}>
  ...
  <Card title="False Positives" icon="flag">
    Contact <SupportLink /> to report persistent false positive patterns.
  </Card>
</CardGroup>
