---
title: Security
description: How Droid CLI keeps your code and data secure with built-in protections and best practices.
keywords: ['security', 'authentication', 'permissions', 'encryption', 'data protection', 'privacy', 'secure']
---

## Security-First Design

Droid CLI is built with security at its core. Your code stays secure through encrypted authentication, strict permissions, and enterprise-grade protections.
...
Droid CLI includes multiple layers of security:
