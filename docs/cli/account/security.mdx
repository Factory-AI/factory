---
title: Security
description: How the Droid CLI keeps your code and data secure with built-in protections and best practices.
keywords: ['security', 'authentication', 'permissions', 'encryption', 'data protection', 'privacy', 'secure']
---

import { SecurityLink, vars } from '/snippets/vars.mdx';

## Security-First Design

The Droid CLI is built with security at its core. Your code stays secure through encrypted authentication, strict permissions, and enterprise-grade protections.
...
<CardGroup cols={2}>
  <Card title="Security Questions" icon="envelope">
    Email our security team: <SecurityLink />
  </Card>
  <Card title="Trust Center" icon="globe">
    Visit <a href={vars.urls.trust}>trust.factory.ai</a> for compliance documents, certifications, and security resources.
  </Card>
</CardGroup>

<Note>
  Report security vulnerabilities through our responsible disclosure program. Contact <SecurityLink /> for details.
</Note>
