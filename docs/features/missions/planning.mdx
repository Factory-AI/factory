...
description: The planning phase is where Missions deliver the most value. Learn how to scope features and milestones, set validation frequency, and estimate cost and duration.
keywords: ['factory missions', 'missions', 'planning', 'milestones', 'validation', 'cost', 'estimation']
---
...
- [Running in the CLI](/cli/features/missions/running-cli) -- Execute and steer an approved plan
- [Configuration & Reference](/features/missions/reference) -- Settings that control workers and validators
