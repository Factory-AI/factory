...
<Note>
  **Looking for Factory Bridge or Cloud Templates?** The Factory App replaces Factory Bridge for local connections, and Cloud Templates are still available when you need a cloud-hosted environment.
</Note>
