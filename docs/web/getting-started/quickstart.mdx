...
<Steps>
  ...
  <Step title="Select Your Machine Connection">
    ...
    4. Bridge automatically adds repositories from the root directory
  ...
  <Step title="Select Model and Tools">
    ...
    <Note>
      Tools extend Factory's capabilities. Learn more about [external integrations](/web/core-concepts/context/external-integrations) to connect with Jira, Notion, Slack, and other platforms.
    </Note>
  </Step>
</Steps>
...
<Steps>
  <Step title="Analyze Your Architecture">
    ...
    <Note>
      Use the context panel to explore all context leveraged by Droid. Learn more about [context management](/web/core-concepts/context/understanding-context).
    </Note>
  </Step>
</Steps>
...
<Steps>
  <Step title="Complex Tasks with External Context">
    ...
    <Note>
      If you've integrated these platforms through Factory's dashboard, Droid can automatically read context from Jira, Notion, Slack, and other sources. Learn about [external integrations](/web/core-concepts/context/external-integrations) for additional capabilities.
    </Note>
  </Step>
</Steps>
...
- Explore [Context Management features](/web/core-concepts/context/understanding-context)
- Review common [Use Cases](/web/use-cases/overview)
- Set up [External Integrations](/web/core-concepts/context/external-integrations)
