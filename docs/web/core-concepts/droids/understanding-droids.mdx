...
<Card title="Explore Specialized Droids" icon="lightbulb" href="/web/droids/using-specialized-droids">
  Learn more about how to select one of Factory's specialized droids for your use case
</Card>
