...
[Learn more about external context →](/core-concepts/context/external-integrations)
...
[Learn more about dynamic context →](/core-concepts/context/dynamic-retrieval)
...
[Learn more about memory as context →](/core-concepts/context/memory)
...
<CardGroup cols={3}>
  <Card title="External Integrations" icon="plug" href="/core-concepts/context/external-integrations">
    Learn about adding tickets, PRs, and other external resources
  </Card>

  <Card title="Dynamic Retrieval" icon="magnifying-glass" href="/core-concepts/context/dynamic-retrieval">
    Understand how Factory pulls in code and files automatically
  </Card>

  <Card title="Memory System" icon="brain" href="/core-concepts/context/memory">
