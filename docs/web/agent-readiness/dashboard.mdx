...
description: Track and analyze your organization's Agent Readiness scores in the Factory App.
keywords:
  [
    "agent readiness",
    "dashboard",
...
![Agent Readiness Dashboard](/images/web/readiness-dashboard.png)
...
![Repository Detail Page](/images/web/readiness-criteria.png)
...
Run the `/readiness-report` [slash command](/cli/features/readiness-report) in the Droid CLI while in the repository directory:
