...
<Warning>
If the Factory Slack app is already installed in your workspace, rerun the Slack install flow below to grant the latest permissions. This enables Droid to ingest images from Slack threads and post videos, generated artifacts, and other files back to Slack.
</Warning>
...
With the Slack integration, Droid can:
...
- Send follow-up messages and image attachments from Slack into an active Droid session
- Answer Droid clarification prompts directly in Slack
