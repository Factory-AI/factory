...
<Steps>
  <Step title="Access Slack integration settings">
    [Log in to your Factory account](https://app.factory.ai), open [**Settings** → **Organization**](https://app.factory.ai/settings/organization), then find **Slack** under **Org Integrations** and click **Manage**.

    <Frame caption="Slack in Organization settings">
      <img src="/images/slack-organization-settings.png" alt="Factory Organization settings page showing Slack under Org Integrations with a Manage button" />
    </Frame>
  </Step>
