...
<Warning>
If the Factory Slack app is already installed in your workspace, rerun the Slack install flow below to grant the latest permissions. This enables Droid to ingest images from Slack threads and post videos, generated artifacts, and other files back to Slack. An admin may have to approve this depending on your Slack workspace settings.
</Warning>
